...
export const TRANSLATIONS = {
  EN: {
    ...
    enterSecret: 'Enter 4-Digit PIN to Reveal',
    verify: 'Verify Now',
    ...
    recoveryError: 'Invalid Email or Secret PIN',
  ...
  BN: {
    ...
    enterSecret: 'দেখার জন্য ৪ সংখ্যার পিন দিন',
    verify: 'যাচাই করুন',
    todaysSummary: 'আজকের হিসাব',
    quickEntry: 'নতুন হিসাব যুক্ত করুন',
    accountRecovery: 'অ্যাকাউন্ট রিকভারি',
    secretTooltip: 'পাসওয়ার্ড ভুলে গেলে পুনরুদ্ধারের জন্য এই পিনটি প্রয়োজন।',
    edit: 'এডিট',
    delete: 'ডিলিট',
    update: 'হিসাব আপডেট',
    print: 'প্রিন্ট করুন',
