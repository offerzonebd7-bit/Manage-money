    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
           ...
           <div className="bg-white dark:bg-gray-800 p-8 rounded-[40px] shadow-sm border dark:border-gray-700 overflow-hidden">
              <h3 className="text-sm font-black mb-6 dark:text-white uppercase tracking-[0.2em] flex items-center">
           ...
           <div className="bg-white dark:bg-gray-800 p-8 rounded-[40px] shadow-sm border dark:border-gray-700">
              <h3 className="text-sm font-black mb-6 dark:text-white uppercase tracking-[0.2em]">Product Summary (Qty)</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                 {Object.entries(productSummary).map(([name, val]: [string, any]) => (
                    <div key={name} className="flex justify-between items-center p-4 bg-gray-50 dark:bg-gray-900 rounded-2xl">
                       <span className="text-[11px] font-black dark:text-white truncate flex-1">{name}</span>
                       <span className="px-3 py-1 bg-primary text-white rounded-lg text-[10px] font-black">{val.qty} PCS</span>
                    </div>
                 ))}
              </div>
           </div>
           ...
           <div className="bg-white dark:bg-gray-800 p-8 rounded-[40px] shadow-sm border dark:border-gray-700">
              ...
              <div className="space-y-4">
                 {Object.entries(categorySummary).map(([cat, val]: [string, any]) => (
                    <div key={cat} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-900 rounded-2xl border-l-4 border-emerald-500">
                       <div>
